...
Run: `cd ios/Contracts && swift test --filter "CrosshairLayout"`
...
Run: `cd ios/Contracts && swift build && swift test --filter "CrosshairLayout"`
...
| 2 | `cd ios/Contracts && swift test --filter "CrosshairLayout"` | `SnappedIndexTests`(5) + `ResolveTests`(7) 全 PASS | □ Pass / □ Fail |
