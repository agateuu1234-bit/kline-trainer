...
grep -nF "破坏前最后非破坏" kline_trainer_modules_v1.4.md      # 破坏前最后非破坏 reload（R10-high#1）
grep -nF "dbCorrupted" kline_trainer_modules_v1.4.md          # 错误类型门：破坏仅 dbCorrupted（FR2 + FR3 final 分流）
```
